...
from HW_14.src.schemas.contacts import ContactSchema
from HW_14.src.database.models import Contact, User
from HW_14.src.repository.contacts import get_all_contacts, get_contacts, get_contact, create_contact, remove_contact, update_contact

class TestContacts(unittest.IsolatedAsyncioTestCase):

    def setUp(self) -> None:
        self.session = AsyncMock(spec=AsyncSession)
        self.contact = Contact(id=1, first_name='test', last_name='testovich', email='test email',
                               phone='09600000022', birthday='12.03.2000')
        self.contacts = [self.contact,
                         Contact(id=2, first_name=self.contact.first_name, last_name=self.contact.last_name,
                                 email='test_email', phone='test_phone', birthday=self.contact.birthday),
    ...
    async def test_create_contact(self):
        ...
        result = await create_contact(body, self.session, User())
